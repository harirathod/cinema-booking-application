 ...
 * @version 2023.03.30
 */
public enum CustomerCommandWord implements CommandWord {
     ...
     */
    CustomerCommandWord(String commandString, String placeholder) {
    ...
    public static String getAllCommands() {
        ...
        for (CustomerCommandWord command : CustomerCommandWord.values()) {
     ...
     */
    public CustomerCommandWord convertToCommandWord(String word)
    {
        if(word == null) {
            return CustomerCommandWord.UNKNOWN;
        }
     ...
     */
    public CustomerCommandWord getQuitCommand() {
        return CustomerCommandWord.QUIT;
    }
}
